...
DO SLEEP(0.1);
#=================
insert into article (headline,category,description,primaryText,primaryMediaUrl,primaryMediaType,statusCode,author) 
...
#=================
insert into article (headline,category,description,primaryText,primaryMediaUrl,primaryMediaType,statusCode,author) 
		values('New Guidebook for Outer Hebridies','3','New Guidebook Published Today','Lorem ipsum dolor. Nullam dictum felis eu pede mollis pretium. Integer','uploads/articles/images/SMCbook.jpg','image','active','1');
...
DO SLEEP(0.1);
#=================
insert into article (headline,category,description,primaryText,primaryMediaUrl,primaryMediaType,primaryMediaCaption,statusCode,author) 
...
#=================
insert into article (headline,category,description,primaryText,primaryMediaUrl,primaryMediaType,statusCode,author) 
		values('Visit Kalymnos!','3','too much bolt clipping','Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean mass quam felis, ultricies nec, pellentesque eu, pretium quis, sem. , mperdiet a, venenatis s pretium. Integer','uploads/articles/images/Gogarth.jpg','image','active','1');
DO SLEEP(0.1);
#=================
