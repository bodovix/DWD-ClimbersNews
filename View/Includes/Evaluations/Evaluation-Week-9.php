...
<div class="container">
    ...
    <p class="text-justify">
        JQuery mobile is an open source framework designed to help developers build responsive “Mobile First” websites. A mobile first development is when a website is designed with the developer targeting the site for mobile devices before Desktop PCs. Mobile first is the opposite of the traditional style of web development where developers build the website for PC monitor sized displays then re-engineer the display to fit mobile screens.
    </p>
    <p>
    ...
    <p class="text-justify">
        The Climbers news web site uses the JQuery mobile framework to display the data retrieved from the Electric Imp device. The frameworks built in functionality is used to display the data in the form of a drop-down for each date and time taken.
    </p>
    <p class="text-justify">
